    ...
    >
      <div className="relative w-full bg-white text-black">
        ...
        <div className="flex justify-end gap-2 mr-10">
          <button
            className="relative z-40 h-10 w-10 rounded-full bg-black flex items-center justify-center text-white disabled:opacity-50"
            onClick={scrollLeft}
...
export const Card = ({
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto bg-white text-white">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              <motion.p
                ...
                className="text-2xl md:text-5xl font-semibold mt-4 text-black"
              >
                {card.title}
              </motion.p>
