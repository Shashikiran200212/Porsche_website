...
const Hero2 = () => {
  ...
  return (
    <div className='h-auto w-full mt-6 overflow-hidden flex flex-col bg-[]'>
        <div className='flex flex-row gap-5'>
            <img src="h3.jpg" alt="" className='' ref={iRef}/>
            <div className='px-7'>
                <TypewriterEffect words={words}  className='mt-2 flex items-start '/>
                <br />

                <div>
                    <p className='text-black text-justify ' ref={pRef}>
                    ...
                    <div className='text-black text-justify 'ref={pRef}>
                    ...
                    <div className=' mt-6'>
                        <button className="px-3 py-1 md:px-6 md:py-3 h-10 w-48 md:h-auto md:w-auto  text-[11px] md:text-[15px] uppercase font-semibold bg-transparent  border-2 border-black transition-transform  transform hover:scale-110 text-black   duration-200 hover:bg-white hover:text-black  hover:border-white-500">
                            <Link href="/Pages/Models">View Models</Link> 
                        </button>
                    </div>

                    <br />
                    <div className='mt-16'>
                        <TypewriterEffect words={words2} className='flex items-start'/>

                        <div className='text-black text-justify mt-3'>
