    ...
    return (
        <div className='h-auto w-full mt-6 overflow-hidden flex flex-col bg-white px-4 sm:px-6 md:px-8 lg:px-10 xl:px-0'>
            <div className='flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 lg:gap-0'>
                ...
                <div className='mt-4 sm:mt-0 sm:ml-4 md:ml-6 flex flex-col xl:p-3'>
                    <TypewriterEffect words={words} className='text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-2xl font-semibold xl:flex px-3'/>
                    <br />
                    <div>
                        <div className='text-black text-justify text-sm sm:text-base md:text-lg lg:text-xl xl:text-normal leading-relaxed px-3' ref={pRef}>
                        ...
                        <div className='mt-6'>
                            <button className="px-4 py-2 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl uppercase font-semibold bg-transparent border-2 border-black transition-transform transform hover:scale-110 text-black duration-200 hover:bg-white hover:text-black">
                        ...
                        <div className='mt-8 xl:px-3'>
                            ...
                            <div className='text-black text-justify text-sm sm:text-base md:text-lg lg:text-xl xl:text-normal leading-relaxed mt-3'>
